...
export default function Nav() {
    return (
        <header className='w-full border-b border-zinc-200'>
            <nav className='container flex flex-col items-center justify-between pt-2 xs:flex-row md:justify-center gap-x-8 xs:pt-0'>
                <Link href='/' className='flex items-center text-base md:text-xl font-semibold gap-x-1.5 hover:text-zinc-500 transition-colors'>
                ...
                <div className='flex gap-x-2 md:gap-x-4'>
                    <Link href='/' className='py-4 text-sm transition-colors border-b-2 border-transparent hover:border-zinc-500 md:text-base'>Home</Link>
                    <Link href='/toppings' className='py-4 text-sm transition-colors border-b-2 border-transparent hover:border-zinc-500 md:text-base'>Toppings</Link>
                    <Link href='/pizzas' className='py-4 text-sm transition-colors border-b-2 border-transparent hover:border-zinc-500 md:text-base'>Pizzas</Link>
                </div>
            </nav>
        </header>
    )
