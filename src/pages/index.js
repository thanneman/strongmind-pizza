        ...
        <main className='container py-6'>
            <div className='flex flex-col items-center mt-20 gap-y-6'>
                ...
                <div className='grid grid-cols-2 gap-2'>
                    <Link href='/toppings' className='flex flex-col items-center justify-between p-4 text-base text-center transition-colors border rounded shadow-sm md:justify-center md:text-lg md:flex-row border-zinc-300 gap-x-2 hover:bg-zinc-100'>
                    ...
                    <Link href='/pizzas' className='flex flex-col items-center justify-between p-4 text-base text-center transition-colors border rounded shadow-sm md:justify-center md:text-lg md:flex-row border-zinc-300 gap-x-2 hover:bg-zinc-100'>
