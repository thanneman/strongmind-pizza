        ...
        <main className='container py-6'>
            <div className='flex flex-col items-center mt-20 gap-y-6'>
                ...
                <div className='grid grid-cols-2'>
                    <Link href='/toppings' className='flex items-center justify-center p-4 m-2 text-lg text-center transition-colors border rounded shadow-sm border-zinc-300 gap-x-2 hover:bg-zinc-100'>
                    ...
                    <Link href='/pizzas' className='flex items-center justify-center p-4 m-2 text-lg text-center transition-colors border rounded shadow-sm border-zinc-300 gap-x-2 hover:bg-zinc-100'>
