        ...
        <main className='container max-w-4xl py-6'>
            <div className='flex flex-col mt-10 gap-y-6'>
                ...
                <div className='flex flex-col mt-5 gap-y-3'>
                    ...
                    <ul className='flex flex-col w-full gap-y-2.5'>
                        {pizzas.map((pizza) => (
                            <div key={pizza.id} className='p-4 border rounded shadow-sm'>
                                <div className='flex justify-between'>
                                    <h3 className='text-lg font-semibold'>{pizza.name}</h3>
                                    <div className='flex gap-x-2'>
                                        <button onClick={() => openDialog(pizza)} className='flex justify-center items-center gap-x-0.5 px-2 py-1 text-white bg-yellow-500 rounded hover:bg-yellow-600'>
                                        ...
                                        <button onClick={() => deletePizza(pizza.id)} className='flex justify-center items-center gap-x-0.5 px-2 py-1 text-white bg-red-500 rounded hover:bg-red-600'>
